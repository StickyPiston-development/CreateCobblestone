...
public class MechanicalGeneratorRenderer extends KineticBlockEntityRenderer<MechanicalGeneratorBlockEntity> {
  ...
  @Override
  protected void renderSafe(MechanicalGeneratorBlockEntity be, float partialTicks, PoseStack ms,
  ...
  private void renderOnSides(PoseStack ms, MultiBufferSource buffer, MechanicalGeneratorBlockEntity be,
      ItemStack renderedItem, int overlay, Vec3[] translations, BlockPos[] sidePositions) {
    ...
    for (int i = 0; i < translations.length; i++) {
      ...
      Minecraft.getInstance().getItemRenderer().renderStatic(renderedItem, ItemDisplayContext.FIXED, light, overlay, ms,
