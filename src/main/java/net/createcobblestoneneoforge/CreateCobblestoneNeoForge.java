package net.createcobblestoneneoforge;
...
import net.createcobblestoneneoforge.data.provider.MechanicalGeneratorLootTableProvider;
import net.createcobblestoneneoforge.data.provider.MechanicalGeneratorRecipeProvider;
import net.createcobblestoneneoforge.data.GeneratorTypesPayload;
import net.createcobblestoneneoforge.data.ResourceReloadListener;
import net.createcobblestoneneoforge.index.*;
...
public class CreateCobblestoneNeoForge {
    public static final String MOD_ID = "createcobblestoneneoforge";
