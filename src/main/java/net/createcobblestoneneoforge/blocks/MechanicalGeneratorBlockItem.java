package net.createcobblestoneneoforge.blocks;
        ...
        if (beData  != null) {
            ...
            if (generatedItem != Items.AIR) {
                tooltipComponents.add(
                        Component.translatable("block.createcobblestoneneoforge.generators.hovertext.itemprefix")
                            .append(generatedItem.getName(generatedItem.getDefaultInstance()))
                            .setStyle(Style.EMPTY.withColor(ChatFormatting.DARK_GRAY))
                );
            } else {
                tooltipComponents.add(
                        Component.translatable("block.createcobblestoneneoforge.generators.hovertext.no_item")
                            .setStyle(Style.EMPTY.withColor(ChatFormatting.DARK_GRAY))
                );
            }
        }
